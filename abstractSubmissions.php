...
class abstractSubmissions extends frontControllerApplication
{
	...
	public function download ()
	{
		...
		$html .= "\n<p class=\"warning\"><strong>Warning:</strong> Microsoft Excel tends to mangle international characters in CSV files. You are strongly recommended to open the CSV files above using <strong>OpenOffice</strong> or <strong>Google Sheets</strong> instead, and select '<strong>Unicode (UTF-8)</strong>' as the character encoding when opening if asked. You can then save the file in the '<strong>Microsoft Excel 97/2000/XP (.xls)</strong>' format, which will preserve the Unicode encoding. Then close (and discard) the CSV file and open the new .xls file using Excel.</p>";
